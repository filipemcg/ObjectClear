...
def object_clear(image: Image.Image, mask: Image.Image, file_name: str, content_id: str, phone: str):
    try:
        ...
        log.error(f"Failed to process object clear for {file_name}: {e}")
    ...
    for contact in contact_list:
        ...
        for content in content_list:
            ...
            if content['type'] == "IMAGE":
                ...
                # APPLY MASK
                mask = MaskFactory.create_mask(domain, s3_record, contact['phone'])
                mask.apply_mask()
                ...
                object_clear(original_image, masked_image, file_name, content['id'], contact['phone'])
